  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-green-50 via-emerald-50 to-teal-100 px-6 py-12">
        {/* Feedback Form */}
        <div className="w-full md:w-2/3 lg:w-1/2 bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-8 border border-green-100">
          <h2 className="text-3xl md:text-4xl font-extrabold text-emerald-900 mb-3">
            Hostel Feedback
          </h2>
          <p className="text-gray-600 mb-8 text-lg">
          Tell us about the Hostels of our college
          </p>

          {/* Canteen Title + Input */}
          <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
            <h3 className="text-2xl font-bold text-emerald-800">Hostel and Accomodation</h3>
