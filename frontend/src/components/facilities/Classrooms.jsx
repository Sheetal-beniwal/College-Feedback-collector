...
export default function Classroom() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFeedbackText("");
      setImageFile(null);
      setRatings({ seating: 0, projectors: 0, cleanliness: 0 });
        ...
        >
          ...
          <div className="w-full md:w-2/3 p-8 md:p-12">
            ...
            <p className="text-gray-600 mb-10 text-lg">
              Help us make learning spaces more inspiring, comfortable, and bright for everyone.
            </p>

            <div className="space-y-8">
              {/* Title + Input */}
              <div className="flex flex-col gap-2">
                <label className="text-lg font-bold text-emerald-800">Classroom Number</label>
                <input
                  type="text"
                  value={classroomNo}
              ...
              <div className="space-y-6 bg-emerald-50/50 p-6 rounded-2xl border border-emerald-100">
                <RatingRow
                  label="Seating, Lighting, & Ventilation"
                  value={ratings.seating}
                  onChange={(val) => handleRating("seating", val)}
                />
                <RatingRow
                  label="Projectors & Smart Board Quality"
              ...
              {/* Feedback Box */}
              <div className="flex flex-col gap-2">
                <label className="text-lg font-bold text-emerald-800">Additional Remarks</label>
                <textarea
